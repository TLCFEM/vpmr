...
def vpmr(
    *,
    ...
    Args:
        ...
        c: Maximum exponent/order used by the algorithm.
        d: Precision in bits. Use ``0`` for automatic precision selection.
        q: Quadrature order.
        m: Precision multiplier.
        e: Convergence tolerance.
        k: Kernel expression in terms of ``t``. Empty string uses the built-in default.
        omit: Whether to omit trivial terms from the output.
    """
    return _pyvpmr.vpmr(
        n=n,
        c=c,
